...
describe 'Imdb::Episode' do
  ...
  it 'has a plot' do
    expect(episode.plot).to match(/Rick is rescued by a group of survivors, but they soon find themselves trapped inside a department store surrounded by walkers./)
  end
